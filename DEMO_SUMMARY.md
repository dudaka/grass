...
python C:/opt/grass/python/libgrass_interface_generator/run.py ^
    --cpp "C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.42.34433/bin/Hostx64/x64/cl.exe -E /D_CRT_SECURE_NO_WARNINGS /DNOMINMAX /DGRASS_CMAKE_BUILD=1 /DWIN32 /D_WINDOWS" ^
    --no-embed-preamble ^
    --compile-libdir "C:/opt/grass/build/output/lib/grass85/lib" ^
    --runtime-libdir "C:/opt/grass/build/output/lib/grass85/lib" ^
    --save-preprocessed-headers "C:/opt/grass/build/preprocessed_headers.h" ^
